...
public class Sell {
	...
	public static class SellMapper extends
	...
	public static class SellReducer extends
	...
	public static JobConf config() {// Hadoop集群的远程配置信息
		JobConf conf = new JobConf(Sell.class);
		conf.setJobName("sell");
		return conf;
	}

	public static Map<String, String> path() {
		Map<String, String> path = new HashMap<String, String>();
		path.put("sell", "sell.csv");// 本地的数据文件
		path.put("input", HDFS + "/chenshang/sell/input");// HDFS的目录
		path.put("output", HDFS + "/chenshang/sell/output"); // 输出目录
		return path;
	}
